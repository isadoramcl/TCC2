...
filhos.push(p('Os multiplicadores de produtividade μ_cognitivo e μ_rede são produzidos por um sistema de inferência difusa de Mamdani–Assilian com duas entradas, três termos linguísticos triangulares por variável, base completa de nove regras e defuzzificação por centroide, seguindo a prática consolidada de acoplar lógica difusa a modelos de dinâmica de sistemas (LIU; TRIANTIS; SARANGI, 2011). Esta estrutura é decisão do TCC II, e não herança da fase conceitual: o TCC I anuncia o emprego de lógica difusa e cita exemplos — funções de pertinência triangulares e inferência pelo método máx-mín —, mas não define quais variáveis entram, quantos termos linguísticos cada uma tem, qual é a base de regras nem o método de defuzzificação. A escolha aqui adotada inclusive DIVERGE do exemplo citado na fase conceitual: a t-norma mínimo foi substituída pela t-norma produto, pela razão exposta adiante nesta seção.'));
filhos.push(pRuns([
...
filhos.push(pRuns([
  ...
  { t: 'A última linha da Tabela ' + T('experimento') + ' move-se em sentido contrário a todas as demais. A investigação dessa discrepância revelou defeito na formulação original da métrica, e não achado substantivo. A razão entre retrabalho e esforço realizado tem por denominador o esforço efetivamente despendido, que inclui o tempo ocioso e bloqueado. O braço centralizado acumula tempo ocioso muito superior — cento e vinte e seis contra seis períodos em média — e, ao inflar o próprio denominador, dilui o retrabalho e aparenta desempenho melhor, ainda que seu esforço de retrabalho absoluto seja trinta e um vírgula um por cento MAIOR que o do arranjo adaptativo — equivalentemente, o do arranjo adaptativo é vinte e três vírgula oito por cento MENOR que o do centralizado. As duas leituras vêm dos mesmos valores, 68,87 contra 52,51, e diferem apenas na base da razão; a redução de vinte e três vírgula oito por cento é sempre relativa ao braço centralizado. A métrica premiava a ineficiência que se pretendia medir.' },
]));
